...
StudentPerformanceDataset_anticipate_test_questions_mode<-names(table(StudentPerformanceDataset$anticipate_test_questions))[
  which(table(StudentPerformanceDataset$anticipate_test_questions)==max(table(StudentPerformanceDataset$anticipate_test_questions)))
]
print(StudentPerformanceDataset_internet_mode)
StudentPerformanceDataset_space_out_revision_mode<-names(table(StudentPerformanceDataset$space_out_revision))[
  which(table(StudentPerformanceDataset$space_out_revision)==max(table(StudentPerformanceDataset$space_out_revision)))
]
print(StudentPerformanceDataset_space_out_revision_mode)
...
sapply(StudentPerformanceDataset[, c(18,8,15)], sd)
...
sapply(StudentPerformanceDataset[, c(18,8,15)], var)
...
require("e1071")
sapply(StudentPerformanceDataset[, c(18,8,15)], kurtosis,type=2)
...
sapply(StudentPerformanceDataset[, c(18,8,15)], skewness, type=2)
...
student_performance_grade <- as.numeric(unlist(StudentPerformanceDataset [, c(18,8,15)]))
hist(student_performance_grade, main = names(StudentPerformanceDataset [, c(18,8,15)]))
...
student_performance_grade <- as.numeric(unlist(StudentPerformanceDataset [, c(18,8,15)]))
boxplot(student_performance_grade, main = names(StudentPerformanceDataset [, c(18,8,15)]))
...
par(mfrow = c(18,8))
for (i in 18:8) {
  barplot(table(StudentPerformanceDataset [, i]), main = names(StudentPerformanceDataset)[i]) 
}
...
pairs(StudentPerformanceDataset)
